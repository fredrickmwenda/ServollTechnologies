<!-- <div class="aside-menu-container" id="sidebar">
    ...
    <div class="aside-menu-container__sidebar-scrolling overflow-auto" style="border:2px solid #1c1414">
...
<div class="sidebar-area" id="sidebar-area">
    <div class="logo position-relative">
        <a href="{{ url('/') }}" class="d-block text-decoration-none position-relative">
            ...
            <span class="logo-text fw-bold text-dark">{{ (strlen(getAppName()) > 15 ) ? substr(getAppName(), 0,15).'...' : getAppName() }}</span>
        </a>
    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu active" data-simplebar>
        <ul class="menu-inner">
            <li class="menu-item">
                <a href="{{ url('/')}}" class="menu-link menu-toggle active">
            ...
            <li class="menu-item open">
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item">
                        <a href="carousels.html" class="menu-link active">
                            Carousels
                        </a>
                    </li>
                    <li class="menu-item">
            ...
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item">
                        <a href="https://templates.envytheme.com/trezo/signin-signup.html" class="menu-link">
                            Signin - Signup
                        </a>
                    </li>
                    <li class="menu-item">
